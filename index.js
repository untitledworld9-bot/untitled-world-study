...
async function initPresence() {
  ...
  // On timer.html, mark as "focusing" so admin Focus card counts them live
  const isTimerPage = page === "timer.html";
  const initStatus  = isTimerPage ? "focusing" : "online";
  ...
  _presenceHB = setInterval(async () => {
    try {
      ...
      const curStatus = curPage === "timer.html" ? "focusing" : "online";
  ...
  // Expose so other page scripts can call window._uwPresence.update("timer")
  window._uwPresence = {
    update: async (page) => {
